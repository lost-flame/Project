...
public class FacultyLogin extends JFrame{
	...
	public FacultyLogin() {
		...
		login = new JLabel("Faculty Login ",JLabel.CENTER);
		login.setLayout(null);
		login.setBounds(400,100,1050,400);
		...
		loginButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				try {
					...
					PreparedStatement ps =con.prepareStatement("select username, password from faculty where username=? and password=?");
