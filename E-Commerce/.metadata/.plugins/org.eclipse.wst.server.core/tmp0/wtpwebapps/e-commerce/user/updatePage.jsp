...
if(userid != null)
{
	...
	PreparedStatement ps = con.prepareStatement("select * from euser where email=? ");
...
<div class="inner">
	...
	<tr>
	<td></td>
	<td><input type="text" value="<%=rs.getString(11)%>" name="securityAnswer" id="securityAnswer" placeholder="your security question" maxlength="50" required/></td>
	</tr>
	<tr>
